  ...
  <q-dialog :model-value="modelValue" @update:model-value="$emit('update:modelValue', $event)">
    <q-card style="width: 500px; max-width: 90vw">
      ...
      <q-card-section class="q-pt-none">
        <q-list separator v-if="historyItem && historyItem.progressions && historyItem.progressions.length > 0">
          <q-item
            v-for="(progression, index) in sortedProgressions"
            :key="index"
          >
            <q-item-section>
              ...
              <div class="q-mt-xs">
                <div class="row items-center">
                  ...
                  <q-linear-progress
                    :value="progression.percent / 100"
                    :color="getProgressColor(progression.percent)"
                    size="6px"
                    rounded
                    class="col"
                  />
...
interface Props {
  ...
  getSortedProgressions: (item: TodoItem) => Array<{ date: string; percent: number }>;
